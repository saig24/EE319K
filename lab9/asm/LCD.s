...
; Last modification date: 4/12/2106
...
;6) If bit 4 is high, loop back to step 5 (wait for BUSY bit to be low)
	LDR R1, =SSI0_SR_R
	LDR R2, [R1]			; R2 contains SR value
	AND R2, #SSI_SR_BSY		; R2 only gets the busy bit of Sr
	CMP R2, #SSI_SR_BSY		; Checks R2 for busy bit being set
	BEQ writecommand
	LDR R1, =DC
	MOV R2, #DC_COMMAND
	STR R2, [R1]
